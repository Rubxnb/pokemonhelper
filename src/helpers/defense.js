export const defense = {
  ...
  fighting: {
    ...
    "x1": ["normal", "fighting", "fire", "water", "electric", "ice", "poison", "ground", "rock", "bug", "ghost", "dragon", "dark", "steel", "grass"],
    "half": ["rock", "bug", "dark"],
    "quarter": [],
    "x0": []
  },
  poison: {
    "x2": ["ground", "psychic"],
    "x1": ["normal", "fire", "water", "electric", "ice", "fighting", "flying", "rock", "ghost", "dragon", "dark"],
  ...
  ground: {
    "x2": ["water", "grass", "ice"],
    "x1": ["normal", "fire", "electric", "poison", "rock", "ghost", "dragon", "dark", "fairy"],
    "half": ["poison", "rock"],
    "quarter": [],
    "x0": ["electric"]
  },
  flying: {
    ...
    "x1": ["normal", "fire", "water", "grass", "poison", "psychic", "ghost", "dragon", "dark", "fairy"],
  ...
  psychic: {
    "x2": ["bug", "ghost", "dark"],
    "x1": ["normal", "fire", "water", "electric", "ice", "fighting", "poison", "ground", "flying", "rock", "dragon", "steel", "fairy"],
  ...
  bug: {
    "x2": ["fire", "flying", "rock"],
    "x1": ["normal", "water", "electric", "ice", "poison", "psychic", "ghost", "dragon", "dark", "fairy"],
  ...
  rock: {
    ...
    "x1": ["normal", "electric", "ice", "psychic", "bug", "ghost", "dragon", "dark", "fairy"],
  ...
  ghost: {
    "x2": ["ghost", "dark"],
    "x1": ["fire", "water", "electric", "ice", "poison", "ground", "flying", "psychic", "rock", "dragon", "steel", "fairy"],
    "half": ["bug", "poison"],
    "quarter": [],
    "x0": ["normal", "fighting"]
  },
  dragon: {
    "x2": ["ice", "dragon", "fairy"],
    "x1": ["normal", "fire", "water", "electric", "grass", "fighting", "poison", "ground", "flying", "psychic", "bug", "ghost", "rock", "dark", "steel"],
  ...
  dark: {
    ...
    "x1": ["normal", "fire", "water", "electric", "grass", "ice", "poison", "ground", "rock", "dragon", "steel"],
    "half": ["ghost", "dark"],
    "quarter": [],
    "x0": ["psychic"]
  },
  steel: {
    ...
    "x1": ["water", "electric", "dark", "dragon"],
    "half": ["normal", "grass", "ice", "flying", "psychic", "bug", "rock", "ghost", "fairy"],
    "quarter": ["steel"],
    "x0": ["poison"]
  },
  fairy: {
    "x2": ["poison", "steel"],
    "x1": ["normal", "fire", "water", "electric", "grass", "ice", "ground", "flying", "psychic", "bug", "rock", "ghost", "fairy"],
